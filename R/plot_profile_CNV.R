...
#' @param z.score whether to plot cluster median z-scores of CNV profile (TRUE) or cluster median CNV profile (FALSE).
...
plot_profile_CNV <- function(scMuffinList = NULL, cluster=0, z.score=TRUE, file=NULL, width=300, height=90, units="mm", res=300, cex.points=0.7, cex.lab=0.7, cex.axis=0.7, cex.main=0.7){
  ...
  plot(0, pch="", ylab="CNV profile", xlab="", xaxt="n", xlim=c(1, nrow(avg_cl_cnv)), ylim=ylim, xaxs="i", main=paste0("Cluster ", cl_lev[j]), cex.axis=cex.axis, cex.lab=cex.lab, cex.main=cex.main)
