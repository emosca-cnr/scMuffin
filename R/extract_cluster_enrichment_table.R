...
#' @param feature_id name of the features that will be considered. Must be any of `colnames(scMuffinList$cluster_data$[[parition_id]]$CSEA$gs_table)` or `names(scMuffinList$cluster_data$[[parition_id]]$ORA)`
