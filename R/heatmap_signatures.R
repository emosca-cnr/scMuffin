...
heatmap_signatures <- function(X, file="heatmap_signatures.jpg", pal=NULL, n_colors=11, seurat_dendrogram=NULL) {
	...
	png(file, width = 180, height = 180, res=300, units="mm")
	...
	legend("bottom", leg_text, pch=16, col=colors_, cex=0.3, xpd=T, pt.cex=0.6)
	...
	axis(1, xx, xx_lab, las=2, cex.axis=0.6)
	axis(2, yy, yy_lab, las=2, cex.axis=0.4)
