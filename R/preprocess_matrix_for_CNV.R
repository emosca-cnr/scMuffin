#' preprocess_matrix_for_cnv
#' @param input_matrix = Seurat object. Preprocessing pipeline to obtain a list of ordered dataframes (chromosomes) 

preprocess_matrix_for_CNV <- function(input_matrix) {
